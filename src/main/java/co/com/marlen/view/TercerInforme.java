...
public class TercerInforme extends javax.swing.JFrame {
    ...
    public void tabla() {
        ...
        try {
            List<TercerInformeVo> lideres = controller.listarTercerInforme();
            String salida = "ID\tConstructora\t\tBanco Vinculado\n----------------------------------------------------------------------------------------------------------------------------\n";
            
            for (TercerInformeVo lider:lideres) {
                salida += lider.getId();
                salida += "\t";
                salida += lider.getConstructora();
                salida += "\t\t";
                salida += lider.getBancoVinculado();
                salida += "\n----------------------------------------------------------------------------------------------------------------------------\n";
            }
            
            jTextAreaT.setText(salida);
    ...
    private void initComponents() {
        ...
        jTextAreaT = new javax.swing.JTextArea();
        cerrar1 = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Tercer Informe");

        jTextAreaT.setColumns(20);
        jTextAreaT.setRows(5);
        jScrollPane2.setViewportView(jTextAreaT);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TercerInforme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextArea jTextAreaT;
